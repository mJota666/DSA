...
void command_3(int argc, char *argv[])
{
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        else if (algorithm_sort.find("bubble") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            bubble_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("counting") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            counting_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("flash") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            flash_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("heap") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            heap_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("insertion") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            insertion_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("radix") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            radix_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("selection") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            selection_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("shaker") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            shaker_sort_comp(a, input_size, count_compare);
        ...
        else if (algorithm_sort.find("shell") != string::npos)
        {
            int count_compare = 0;
            long double time_use = 0;
            shell_sort_comp(a, input_size, count_compare);
